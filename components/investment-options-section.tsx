...
import { TrendingUp, Tag, Briefcase } from "lucide-react";
...
export function InvestmentOptionsSection() {
  ...
  return (
    <section className="w-full bg-linear-to-b from-[#eaf3fa] to-[#e1eff8] py-20 md:py-28 relative font-sans overflow-hidden">
      <div className="w-full max-w-[1100px] mx-auto px-6 md:px-12 relative z-10">
        <h2 className="text-center font-bold text-[#203a53] text-[28px] md:text-[34px] tracking-tight mb-2">
          Multiple ways to grow your wealth
        </h2>
        <p className="text-center text-[#6e859b] text-[15px] md:text-[17px] font-medium mb-16 md:mb-24 max-w-[600px] mx-auto">
          Diversified investment options selected and optimized by WealthUp.
        </p>

        {/* Flat 2D Isometric Buttons Area */}
        <div className="flex flex-col md:flex-row justify-center items-center gap-6 md:gap-14 mb-24 md:mb-32 mt-10 md:mt-16">
          {TABS.map((tab) => {
            ...
            return (
              <button
                ...
                className={cn(
                  ...
                  isActive
                    ? "bg-[#385572] text-white border-[#385572]"
                    : "bg-[#ffffff] text-[#385572] border-[#385572]",
                )}
                style={{
              ...
              >
                ...
                <div
                  className={cn(
                    ...
                    isActive
                      ? "bg-white"
                      : "bg-white border-[1.5px] border-[#385572]",
                  )}
                >
                  <tab.icon
                    className={cn(
                      "w-[16px] h-[16px] md:w-[18px] md:h-[18px] stroke-[2.5]",
                      isActive ? "text-[#385572]" : "text-[#385572]",
                    )}
                  />
                </div>
        ...
        <div className="rounded-[24px] border border-black/20 bg-white/30 backdrop-blur-xl shadow-[0_8px_32px_rgba(30,50,70,0.1)] overflow-hidden transition-all duration-500 max-w-[1050px] mx-auto relative z-10 flex flex-col md:flex-row m-0 p-0 h-auto md:min-h-[220px]">
          {TABS.map((tab) => {
            const isActive = activeTab === tab.id;
            return (
              <div
                ...
                className={cn(
                  ...
                  isActive
                    ? "bg-[#385572]/85 backdrop-blur-md text-white shadow-inner border-r border-[#ffffff]/10 hover:bg-[#385572]/90"
                    : "bg-transparent text-[#203a53]",
                )}
              >
